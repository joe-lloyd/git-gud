# pull-modes Specification

## Purpose
Offer explicit pull strategies (git's default, fast-forward only, and rebase) from the toolbar Pull button, and explain a refused fast-forward-only pull instead of surfacing the raw git error.
