# gerrit-review-push Specification

## Purpose
Provide a Gerrit push-for-review action (`git push <remote> HEAD:refs/for/<branch>` with optional push options) as the primary toolbar push in Gerrit mode, kept separate from the unchanged plain push, with actionable classification of well-known Gerrit rejections.
