...
app.whenReady().then(async () => {
  ...
  ipcMain.handle('peer:set-device-scopes', async (_event, peerId: string, scopes: string[]) => peerService?.setDeviceScopes(peerId, Array.isArray(scopes) ? scopes.map(String) : []) ?? false)
